...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='G:\\Ghazaleh Khosravi\\Task Design Psychopy\\VPT_Farsi_github\\Male_Task\\code\\Maryam_Gholipour_Male.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Room_Background = visual.ShapeStim(
    ...
    Practice = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Male_pilot.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    Loop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('Male_experimental.xlsx'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    End = data.Routine(
        name='End',
        components=[End_Background, Thank_You],
    )
